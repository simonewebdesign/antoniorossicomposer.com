...
<div id=flags>
  ...
  $(function(){
    ...
    if (Modernizr.audio) { // HTML5 audio supported
    ...
    } else { // HTML5 audio not supported
      ...
      if (lang == 'en') {
        ...
        $('#intro-wrapper').append('<p>Il tuo browser web non supporta alcune delle tecnologie usate all\'interno di questo sito.<br>Per una migliore esperienza di navigazione, ti consigliamo di scaricare gratuitamente <a style="color:orange" href="http://mozilla.org/firefox">Mozilla Firefox.</a>');
      }
